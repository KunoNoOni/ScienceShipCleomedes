package
{
	...
	public class CutScene1 extends FlxState
	{
		...
		private var dialog:Array = new Array("Captain: Earth this is the Science Ship Cleomedes do you read me?\nEarth: ..." +
			"\nCaptain: Successfully navigated an asteriod field...\nTactical: Captain! I'm detecting many small ships ahead.\n" +
			"Captain: We're about to be attacked by Space Pirates!\nEarth: ...\n\nPress [x] to continue");
